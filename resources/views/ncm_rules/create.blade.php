        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div class="bg-gray-50 px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-medium text-gray-900">Criar Nova Regra</h3>
                    <p class="mt-1 text-sm text-gray-600">Defina quando um NCM específico deve exigir código GTIN</p>
                </div>

                <!-- Formulário -->
                <div class="px-6 py-6">
                    <form method="POST" action="{{ route('ncm_rules.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <textarea name="note" 
                                      ...
                                      placeholder="Ex: Grupo I — Tabaco, Produtos farmacêuticos, etc.">{{ old('note') }}</textarea>
                            @error('note')
                                <div class="mt-2 flex items-center text-red-600 text-sm">
                                    <i class="fas fa-exclamation-circle mr-1"></i>
                                    {{ $message }}
