		...
		<div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
			...
			<div class="mb-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4 flex items-start gap-3">
				...
				<div class="text-yellow-900">
					...
					<div class="text-sm mt-1">Este pedido foi cancelado. Considere explicar o motivo do cancelamento na mensagem para o cliente.</div>
				</div>
			</div>
			@endif
