    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <h2 class="font-semibold text-xl text-gray-800 leading-tight">Nova Conta a Receber</h2>
                    <p class="text-sm text-gray-500">Registre uma nova receita a receber</p>
                </div>
            </div>
            ...
            <div class="bg-white shadow-xl rounded-2xl overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-green-500 to-green-600 px-6 py-4">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-white">Informações da Conta a Receber</h3>
                            <p class="text-green-100 text-sm">Preencha os dados da receita</p>
                        </div>
                    </div>
                </div>

                <!-- Formulário -->
                <form action="{{ route('receivables.store') }}" method="POST" class="p-6 space-y-6" x-data='receivableForm()'>
                    @csrf
                    ...
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="document_number" value="{{ old('document_number') }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors" placeholder="Ex.: 12345">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="description" value="{{ old('description') }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors" placeholder="Ex.: Venda de produtos" required>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" step="0.01" name="amount" value="{{ old('amount') }}" class="w-full pl-8 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors" placeholder="0,00" required>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" name="due_date" x-model="dueDate" @change="checkDueDate()" value="{{ old('due_date') }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors" required>
