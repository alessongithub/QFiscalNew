<x-app-layout>
    ...
    <div class="max-w-6xl mx-auto">
        <form id="supplierForm" action="{{ route('suppliers.update', $supplier) }}" method="POST" class="space-y-8">
            @csrf @method('PUT')
                ...
                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        ...
                        <label class="inline-flex items-center gap-2 text-sm font-medium text-gray-700">
                            <input type="checkbox" name="active" value="1" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" @checked(old('active', $supplier->active))>
                        <span>Ativo</span>
                    </label>
                    </div>
                </div>
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="cpf_cnpj" value="{{ old('cpf_cnpj', $supplier->cpf_cnpj) }}" 
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="ie_rg" value="{{ old('ie_rg', $supplier->ie_rg) }}" 
                    ...
                    <div class="mb-6">
                        <div class="flex items-center gap-4">
                            <div class="flex-1 max-w-xs">
                                ...
                                <div class="relative">
                                    <input id="zip_code" type="text" name="zip_code" value="{{ old('zip_code', $supplier->zip_code) }}" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                        ...
                        <div class="md:col-span-4 space-y-2">
                            ...
                            <div class="flex items-center gap-2">
                                <input id="number" type="text" name="number" value="{{ old('number', $supplier->number) }}" 
                                ...
                                <label class="flex items-center gap-1 text-sm text-gray-600 cursor-pointer whitespace-nowrap">
                                    <input type="checkbox" id="sem-numero" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" {{ old('number', $supplier->number) === 'S/N' ? 'checked' : '' }}>
                                    <span>S/N</span>
                                </label>
                        </div>
                            @error('number')
                        ...
                        <div class="md:col-span-3 space-y-2">
                            ...
                            <input id="state" type="text" name="state" value="{{ old('state', $supplier->state) }}" maxlength="2" 
                        ...
                        <div class="md:col-span-4 space-y-2">
                            ...
                            <input id="neighborhood" type="text" name="neighborhood" value="{{ old('neighborhood', $supplier->neighborhood) }}" 
                        ...
                        <div class="md:col-span-4 space-y-2">
                            ...
                            <input type="text" name="complement" value="{{ old('complement', $supplier->complement) }}" 
