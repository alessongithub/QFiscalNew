<x-app-layout>
	<x-slot name="header">
		<div class="flex items-center justify-between">
			<div>
				<h2 class="font-semibold text-xl text-gray-800 leading-tight">Enviar Orçamento por E-mail</h2>
				<p class="text-sm text-gray-600 mt-1">Envie o orçamento #{{ $quote->number }} para o cliente</p>
			</div>
	...
	<div class="py-6">
		<div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
			...
			<div class="bg-white overflow-hidden shadow-lg rounded-xl">
				...
				<form action="{{ route('quotes.email_send', $quote) }}" method="POST" class="p-6 space-y-6">
					@csrf
					...
					<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
						...
						<div class="space-y-2">
							...
							<input type="text" name="subject" value="{{ old('subject', $subject) }}" 
								   class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200" 
								   placeholder="Orçamento - Sua Empresa" required>
						</div>
					</div>
					...
					<div class="space-y-2">
						...
						<select name="template" class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200">
							<option value="quote_default" @selected(old('template','quote_default')==='quote_default')>📄 Template Padrão de Orçamento</option>
					...
					<div class="space-y-2">
						...
						<textarea name="message" rows="8" 
								  class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 resize-none" 
