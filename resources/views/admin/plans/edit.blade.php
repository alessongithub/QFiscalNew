        ...
        <div class="p-6 text-gray-900">
            <form method="POST" action="{{ route('admin.plans.update', $plan) }}" class="space-y-6">
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="3" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('description', $plan->description) }}</textarea>
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <x-text-input id="max_clients" name="max_clients" type="number" step="1" placeholder="50 ou -1" class="mt-1 block w-full" :value="old('max_clients', $f['max_clients'] ?? 50)" />
                            <x-input-error :messages="$errors->get('max_clients')" class="mt-2" />
                        </div>
                        <div>
                            <x-input-label for="max_users" :value="__('Máximo de Usuários')" />
                            <x-text-input id="max_users" name="max_users" type="number" step="1" placeholder="1 ou -1" class="mt-1 block w-full" :value="old('max_users', $f['max_users'] ?? 1)" />
                            <x-input-error :messages="$errors->get('max_users')" class="mt-2" />
                        </div>
                        <div>
                            <x-input-label for="max_products" :value="__('Máximo de Produtos')" />
                            <x-text-input id="max_products" name="max_products" type="number" step="1" placeholder="100 ou -1" class="mt-1 block w-full" :value="old('max_products', $f['max_products'] ?? null)" />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-3">
                            <div class="flex items-center">
                                <input id="has_erp" name="has_erp" type="checkbox" value="1" {{ old('has_erp', $f['has_erp'] ?? true) ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                <label for="has_erp" class="ml-2 text-sm text-gray-900">Acesso ao ERP</label>
                            </div>
                            <div class="flex items-center">
                                <input id="has_emissor" name="has_emissor" type="checkbox" value="1" {{ old('has_emissor', $f['has_emissor'] ?? false) ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                <label for="has_emissor" class="ml-2 text-sm text-gray-900">Acesso ao Emissor Fiscal</label>
                            </div>
                            <div class="flex items-center">
                                <input id="has_api_access" name="has_api_access" type="checkbox" value="1" {{ old('has_api_access', $f['has_api_access'] ?? false) ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                <label for="has_api_access" class="ml-2 text-sm text-gray-900">Acesso à API</label>
                            </div>
                            <div class="flex items-center">
                                <input id="allow_issue_nfe" name="allow_issue_nfe" type="checkbox" value="1" {{ old('allow_issue_nfe', $f['allow_issue_nfe'] ?? false) ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                <label for="allow_issue_nfe" class="ml-2 text-sm text-gray-900">Permitir Emissão de NF-e no ERP</label>
                            </div>
                            <div class="flex items-center">
                                <input id="allow_pos" name="allow_pos" type="checkbox" value="1" {{ old('allow_pos', $f['allow_pos'] ?? false) ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <select id="erp_access_level" name="erp_access_level" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    ...
                                    @php $erpLevel = old('erp_access_level', $f['erp_access_level'] ?? ''); @endphp
                                    <option value="free" {{ $erpLevel === 'free' ? 'selected' : '' }}>Free (Gratuito)</option>
                                    <option value="basic" {{ $erpLevel === 'basic' ? 'selected' : '' }}>Básico</option>
                                    <option value="professional" {{ $erpLevel === 'professional' ? 'selected' : '' }}>Profissional</option>
                                    <option value="enterprise" {{ $erpLevel === 'enterprise' ? 'selected' : '' }}>Enterprise</option>
                                </select>
                            ...
                            <div>
                                ...
                                <select id="support_type" name="support_type" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    @php $support = old('support_type', $f['support_type'] ?? 'email'); @endphp
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <x-text-input id="storage_data_mb" name="storage_data_mb" type="number" step="1" placeholder="50 ou -1" class="mt-1 block w-full" :value="old('storage_data_mb', $f['storage_data_mb'] ?? 50)" />
                        ...
                        <div>
                            ...
                            <x-text-input id="storage_files_mb" name="storage_files_mb" type="number" step="1" placeholder="500 ou -1" class="mt-1 block w-full" :value="old('storage_files_mb', $f['storage_files_mb'] ?? 500)" />
                        ...
                        <div>
                            ...
                            <x-text-input id="additional_data_price" name="additional_data_price" type="number" step="0.01" class="mt-1 block w-full" :value="old('additional_data_price', $f['additional_data_price'] ?? 9.90)" />
                        ...
                        <div>
                            ...
                            <x-text-input id="additional_files_price" name="additional_files_price" type="number" step="0.01" class="mt-1 block w-full" :value="old('additional_files_price', $f['additional_files_price'] ?? 9.90)" />
                ...
                <div class="pb-6">
                    ...
                    <div class="flex items-center">
                        <input id="active" name="active" type="checkbox" value="1" {{ old('active', $plan->active) ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
