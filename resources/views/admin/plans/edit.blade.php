                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:col-span-2">
                        <div>
                            ...
                            <x-text-input id="max_clients" name="max_clients" type="number" step="1" placeholder="Ex.: 50 ou -1" class="mt-1 block w-full" :value="old('max_clients', $f['max_clients'] ?? 50)" />
                        ...
                        <div>
                            ...
                            <x-text-input id="max_users" name="max_users" type="number" step="1" placeholder="Ex.: 3 ou -1" class="mt-1 block w-full" :value="old('max_users', $f['max_users'] ?? 1)" />
                        ...
                        <div>
                            ...
                            <x-text-input id="max_products" name="max_products" type="number" step="1" placeholder="Ex.: 100 ou -1" class="mt-1 block w-full" :value="old('max_products', $f['max_products'] ?? null)" />
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="display_features_text" name="display_features_text" rows="4" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('display_features_text', isset($f['display_features']) ? implode("\n", $f['display_features']) : '') }}</textarea>
